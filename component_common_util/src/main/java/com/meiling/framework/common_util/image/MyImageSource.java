...
public final class MyImageSource {
    ...
    private MyImageSource(Bitmap bitmap, boolean cached) {
        this.bitmap = bitmap;
        this.uri = null;
        this.resource = null;
        this.tile = false;
    ...
    private MyImageSource(@NonNull Uri uri) {
    ...
    private MyImageSource(int resource) {
        this.bitmap = null;
        this.uri = null;
     ...
     * @return an {@link MyImageSource} instance.
     */
    @NonNull
    public static MyImageSource resource(int resId) {
        return new MyImageSource(resId);
    }
     ...
     */
    @NonNull
    public static MyImageSource asset(@NonNull String assetName) {
     ...
     */
    @NonNull
    public static MyImageSource uri(@NonNull String uri) {
        //noinspection ConstantConditions
        if (uri == null) {
        ...
        return new MyImageSource(Uri.parse(uri));
    }
     ...
     */
    @NonNull
    public static MyImageSource uri(@NonNull Uri uri) {
        //noinspection ConstantConditions
        if (uri == null) {
            throw new NullPointerException("Uri must not be null");
        }
        return new MyImageSource(uri);
    }
     ...
     */
    @NonNull
    public static MyImageSource bitmap(@NonNull Bitmap bitmap) {
        //noinspection ConstantConditions
        if (bitmap == null) {
            throw new NullPointerException("Bitmap must not be null");
        }
        return new MyImageSource(bitmap, false);
    }
     ...
     */
    @NonNull
    public static MyImageSource cachedBitmap(@NonNull Bitmap bitmap) {
        //noinspection ConstantConditions
        if (bitmap == null) {
            throw new NullPointerException("Bitmap must not be null");
        }
        return new MyImageSource(bitmap, true);
    }
     ...
     */
    @NonNull
    public MyImageSource tilingEnabled() {
        return tiling(true);
    }
     ...
     */
    @NonNull
    public MyImageSource tilingDisabled() {
        return tiling(false);
    }
     ...
     */
    @NonNull
    public MyImageSource tiling(boolean tile) {
        this.tile = tile;
        return this;
    }
     ...
     */
    @NonNull
    public MyImageSource region(Rect sRegion) {
     ...
     */
    @NonNull
    public MyImageSource dimensions(int sWidth, int sHeight) {
        if (bitmap == null) {
            this.sWidth = sWidth;
